...
import com.felix.middleware.server.entity.Fruit;
import com.felix.middleware.server.entity.Person;
import com.felix.middleware.server.entity.PhoneUser;
import com.felix.middleware.server.entity.Student;
...
public class RedisTest2 {
    ...
    public void one() throws JsonProcessingException {
        Person p = new Person(10013, 24, "羊角", "felix", "杭州");
    ...
    public void two() {
        ...
        //从队头读取
        log.info("--读取Redis中List的数据-从队头中获取--");
    ...
    public void six() throws InterruptedException {
        ...
        //第一种方法：在往缓存中set数据时，提供一个TTL，表示TTL时间一到，缓存中的key将自动失效
        //在这里TTL是10秒
        ...
        log.info("再等待5秒-判断key是否还存在：{} 对应的值：{}", existKey1, value);
    }
    ...
    public void seven() throws InterruptedException {
        ...
        log.info("再等待5秒-判断key是否还存在：{} 对应的值：{}", existKey2, value);
    }
}
